...
class CustomTextFormField extends StatelessWidget {
  ...
  Widget textFormFieldWidget(BuildContext context) => SizedBox(
        ...
        child: TextFormField(
          ...
          autofocus: autofocus!,
          style: textStyle ?? CustomTextStyles.labelMediumBlack90001,
  ...
  InputDecoration get decoration => InputDecoration(
        hintText: hintText ?? "",
        hintStyle: hintStyle ?? CustomTextStyles.labelLargeInterGray400,
        prefixIcon: prefix,
...
extension TextFormFieldStyleHelper on CustomTextFormField {
  static OutlineInputBorder get underLinePrimary => OutlineInputBorder(
        borderSide: BorderSide.none,
      );
  static OutlineInputBorder get underLineBlueGray => OutlineInputBorder(
        borderSide: BorderSide.none,
      );
