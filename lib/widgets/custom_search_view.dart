...
class CustomSearchView extends StatelessWidget {
  ...
  Widget searchViewWidget(BuildContext context) => SizedBox(
        ...
        child: TextFormField(
          ...
          autofocus: autofocus!,
          style: textStyle ?? CustomTextStyles.bodyMediumBeVietnamProGray600,
  ...
  InputDecoration get decoration => InputDecoration(
        hintText: hintText ?? "",
        hintStyle: hintStyle ?? CustomTextStyles.bodyMediumPoppinsGray40001,
        prefixIcon: prefix ??
            Container(
              margin: EdgeInsets.fromLTRB(22.h, 17.v, 17.h, 15.v),
              child: CustomImageView(
                imagePath: ImageConstant.imgContrastBlueGray300,
                height: 26.adaptSize,
                width: 26.adaptSize,
              ),
            ),
