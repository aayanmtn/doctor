...
class CustomFloatingTextField extends StatelessWidget {
  ...
  Widget floatingTextFieldWidget(BuildContext context) => SizedBox(
        ...
        child: TextFormField(
          ...
          autofocus: autofocus!,
          style: textStyle ?? CustomTextStyles.bodySmallPoppinsBluegray200,
  ...
  InputDecoration get decoration => InputDecoration(
        hintText: hintText ?? "",
        hintStyle: hintStyle ?? CustomTextStyles.bodySmallPoppinsBluegray200,
        labelText: labelText ?? "",
        ...
        isDense: true,
        contentPadding:
            contentPadding ?? EdgeInsets.fromLTRB(10.h, 10.v, 10.h, 19.v),
        fillColor: fillColor,
        filled: filled,
